    ...
    <>
      <div className="carousel w-full h-[90vh]">
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute top-0 opacity-50 bg-white w-full h-full"></div>
          <h1 className="absolute top-[40%] w-full pb-2 text-center lg:text-5xl text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-orange-500 to-red-600 ">
            Nameing Ceremony
          </h1>
          <p className="text-black absolute text-center top-[55%] mt-2 w-full md:px-28">
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a
              href="#slide5"
              className="btn btn-circle bg-transparent text-xl border-none"
            >
              ❮
            </a>
            <a
