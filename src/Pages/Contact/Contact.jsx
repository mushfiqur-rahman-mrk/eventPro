...
const Contact = () => {
  ...
  return (
    <>
      <Navbar></Navbar>
      <div
        className="grid grid-cols-1 md:grid-cols-3 my-20 gap-8 px-5 max-w-6xl mx-auto justify-center items-center"
        data-aos="fade-up"
            ...
            <div className="bg-white dark:bg-gray-900">
              <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <form ref={form} onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-10">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Holiday Happening">
                          Holiday Happening
                        </option>
                  ...
                  <button className="px-5 text-white font-semibold bg-gradient-to-r from-orange-500 to-red-600  hover:ease-in py-3 transition duration-150 hover:text-black rounded-xl shadow-lg mx-auto md:w-1/2 ">
                    Submit
                  </button>
                </form>
              </div>
